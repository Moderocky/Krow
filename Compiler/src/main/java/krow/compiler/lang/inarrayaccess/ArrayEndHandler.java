package krow.compiler.lang.inarrayaccess;
...
public class ArrayEndHandler implements DefaultHandler {
    ...
    public HandleResult handle(String statement, PreClass data, CompileContext context) {
        ...
        if (PATTERN.matcher(statement).find()) {
            ...
            context.lookingFor = array.type.componentType();
            context.child.skip(PreVariable.store(array.type, 0));
